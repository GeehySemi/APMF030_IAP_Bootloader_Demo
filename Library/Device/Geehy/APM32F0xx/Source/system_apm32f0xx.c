...
//#define SYSTEM_CLOCK_HSE    HSE_VALUE     /** HSE is used as system clock source */
//#define SYSTEM_CLOCK_24MHz  (24000000)    /** HSE (8MHz) used to clock the PLL, and the PLL is used as system clock source */
//#define SYSTEM_CLOCK_36MHz  (36000000)    /** HSE (8MHz) used to clock the PLL, and the PLL is used as system clock source */
#define SYSTEM_CLOCK_48MHz  (48000000)    /** HSE (8MHz) used to clock the PLL, and the PLL is used as system clock source */
